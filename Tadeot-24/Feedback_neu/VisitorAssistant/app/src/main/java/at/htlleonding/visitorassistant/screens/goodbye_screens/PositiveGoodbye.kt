...
fun PositiveGoodbye(navController: NavController) {
    ...
    Log.d("Navigation", "Rendering Positiv Goodbyscreen")
    ...
    if (firstSwitchPositiveBye) {
        ...
        Log.d("If Statement", "Reaching end of Goodbyscreen")
        ...
        object : CountDownTimer(2000, 1000){
            ...
            override fun onTick(millisecUntilFinished: Long) {
                Log.d("CountDown", "Seconds till Findished: $millisecUntilFinished")
            }
            override fun onFinish() {
                Log.d("CountDown Finished", "Countdown finsihed: Navigation to Homescreen")
